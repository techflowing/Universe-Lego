...
import win.techflowing.android.ui.R;
import win.techflowing.android.ui.banner.loader.ImageLoaderInterface;
import win.techflowing.android.ui.banner.view.BannerViewPager;
...
public class Banner extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        bannerBackgroundImage = typedArray.getResourceId(R.styleable.Banner_banner_default_image, R.drawable.banner_no_banner);
        typedArray.recycle();
    }
